                        ...
                        <div class="single-item-body">
                            ...
                            @if(($product->discount) ==0)
                                <p class="single-item-price">
                                    <span><b>Giá:</b>   {{number_format($product->price)}}đ</span>
                                </p>
                            @else
                                <p class="single-item-price">
                                ...
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="" data-toggle="modal" data-target="#modalProduct"><img
                                                    src="{{asset($productNews->image)}}" height="200px" alt=""></a>
                                    </div>
                                    <div class="single-item-body">
                                    ...
                                    <div class="single-item-caption">
                                        ...
                                        <a class="product-detail" href="{{route("product",$productNews->slug)}}">Chi Ti <i
                        ...
                        @foreach($quantitys as $quantity)
                            <div class="media">
                                <a class="pull-left" href="">
                                    <img src="{{asset($quantity->image)}}" alt="">
                                </a>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @foreach($new as $newt)
                            ...
                            <div class="media">
                                <a class="pull-left" href="{{route("product",$newt->slug)}}">
                                    <img src="{{asset($newt->image)}}" alt="">
                                </a>
                                <div class="media-body">
