                            ...
                            <div class="single-item">
                                ...
                                <div class="single-item-header">
                                    <a href="{{route("product",$new_product->id)}} ">
                                        <img src="bootstrap/images/products/{{$new_product->image}}" height="250px" alt=""></a>
                                </div>
                                ...
                                <div class="single-item-caption">
                                    ...
                                    <a class="product-detail" href="{{route("product",$new_product->id)}}">Chi tiết <i
                            ...
                            <div class="single-item">
                                ...
                                <div class="single-item-header">
                                    <a href="{{route("product",$promotion_product->id)}}" data-toggle="modal" data-target="#modalProduct"><img
                                                src="bootstrap/images/products/{{$promotion_product->image}}" height="250px" alt=""></a>
                                </div>
                                <div class="single-item-body">
                                ...
                                <div class="single-item-caption">
                                    <a class="add-to-cart pull-left" href="shopping_cart.html"><i
                                                class="fa fa-shopping-cart"></i></a>
                                    <a class="product-detail" href="{{route("product",$promotion_product->id)}}">Chi tiết <i
                                                class="fa fa-chevron-right"></i></a>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
